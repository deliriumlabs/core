<script>
	...
	function instalar(){
			switch(fase){
				...
				case "final":
					fase="null";
					mvcPost("System::admin_modulo_registrar",'uuid='+modulo.uuid,'');
...
<span class="button">
	<input type="button" value="Cargar Modulo Nuevo" onclick="_window({mvc:'system::view_admin_modulo_upload',width:'400',height:'80',modal:true})" />
</span>
<table class="search_default" id="lista_modulos" >
	<caption>
			<strong>Modulos no registrados</strong>
	</caption>
    <thead>
		<tr>
			<th>
			...
			<th>
                <input type="button" value="Instalar modulos seleccionados" class="btn btn_gear" onclick="instalar_modulos_lista();"/>
			</th>
		</tr>
    </thead>
	<tbody>
		...
		<tr class="[_row_class_]">
            ...
            <td align="center">
                &nbsp;&nbsp;&nbsp;
                <input class="btn btn_gear" type="button" onclick="mvcPost('System::admin_modulos_info','uuid=[uuid]','','instalar_modulo');"; value="Instalar" />
            </td>
		</tr>
		{{END lista_modulos}}
	</tbody>
